...
const GameStart: FC = () => {
  return (
    <section className="container m-auto max-w-screen-xl w-11/12 flex flex-col justify-center items-center md:items-start">
      ...
      <p className="text-base my-2 text-zinc-900">
        Ваша черная дыра начинает свое путешествие будучи небольшим объектом, но
        она может поглощать другие объекты для увеличения своего веса и мощи.
        Каждый объект в игре, включая вашу черную дыру, имеет свой вес.
      </p>
      <p className="text-base my-2 text-zinc-900">
        ...
        объект тяжелее вашей черной дыры, она получит урон. Ваша задача - стать
        настолько большой и мощной, чтобы суметь поглотить абсолютно все.
      </p>
